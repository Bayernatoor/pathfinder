...
use pathfinder::models::{OutPoint, Transaction, TxInput, TxOutput};
...
async fn main() {
    ...
    //     json!("ea30577074d9a93457b2c0b87bb33ad2942dca1845ef88c5538512b27388f266"),
    //     json!(1),
    // ];
    // let txid = vec![
    ...
    //     .rpc_call("getrawtransaction", txid)
    //     .await
    //     .unwrap();
}
